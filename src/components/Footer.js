...
const Footer = () => {
  ...
  style={{ backgroundColor: '#929fba', fontFamily: 'Verdana, sans-serif' }}
>
        ...
        <section className="">
          <div className="row">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <p>
                <a href="/compra" className="text-white">Compra de Boletos</a>
              </p>
              <p>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p><i className="fas fa-home mr-3"></i> Diagonal Las Perdices, Peñalolen</p>
