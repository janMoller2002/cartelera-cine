...
const AboutUs = () => {
  return (
    <main className="container my-5" style={{ fontFamily: 'Verdana, sans-serif', marginBottom: '60px' }}>
      <div className="text-center">
        <h1 className="my-4" style={{ fontFamily: 'Verdana, sans-serif',}} >Sobre Nosotros</h1>
        <hr />
      </div>
